        ...
        g.querySelectorAll &&
          (function () {
            ...
            (K(function (e) {
              ...
              K(function (e) {
                ((e.innerHTML = "<p Admin=''></p>"),
                  e.querySelectorAll("[Admin^='']").length &&
                    i.push("[*^$]=" + O + "*(?:\"\"|'')"),
              ...
              u &&
                (K(function (t) {
                  e = u.call(t, "div");
                  try {
                    (u.call(t, "[Admin!='']:sizzle"), s.push("!=", H));
                  } catch (n) {}
                }),
                (s = new RegExp(s.join("|"))),
    ...
    _refreshValue: function () {
      ...
      if (this.options.values && this.options.values.length)
        this.handles.each(function (h) {
          e =
            ((c.values(h) - c._valueMin()) / (c._valueMax() - c._valueMin())) *
            100;
          ...
          if (c.options.range === true)
            if (c.orientation === "horizontal") {
              if (h === 0)
                c.range
                  .stop(1, 1)
                  [f ? "animate" : "css"]({ left: e + "%" }, b.animate);
              if (h === 1)
              ...
              if (h === 0)
                c.range
                  .stop(1, 1)
                  [f ? "animate" : "css"]({ bottom: e + "%" }, b.animate);
              if (h === 1)
                c.range[f ? "animate" : "css"](
                  { height: e - g + "%" },
                  { queue: false, duration: b.animate },
    ...
    _disableDatepicker: function (a) {
      ...
      if (b.hasClass(this.markerClassName)) {
        ...
        if (e == "input") {
          ...
          b.find("select.ui-datepicker-month, select.ui-datepicker-year").attr(
            "disabled",
            "disabled",
          );
        }
            ...
            for (t = 0; t < 7; t++) {
              ...
              R +=
                ...
                ((r.getTime() == P.getTime() &&
                  g == a.selectedMonth &&
                  a._keyEvent) ||
                (E.getTime() == r.getTime() && E.getTime() == P.getTime())
                  ? " " + this._dayOverClass
                  : "") +
                (L
                  ...
                  : L
                    ...
                    : '<a class="ui-state-default' +
                      (r.getTime() == b.getTime()
                        ? " ui-state-highlight"
                        : "") +
                      (r.getTime() == u.getTime() ? " ui-state-active" : "") +
