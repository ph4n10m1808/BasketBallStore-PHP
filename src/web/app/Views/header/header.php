        ...
        <div class="container-fluid w-100 d-flex justify-content-end mx-2">
            ...
            if (!$login) {
                ...
                switch ($userAccount['id_auth']) {
                    case 1:
                        $authMenu = '<li><a class="dropdown-item text-success" href="admin.php?mod=dashboard" target="_blank"><i class="fas fa-cog me-2" style="width:16px;"></i>Trang quản lý</a></li>';
                        break;
                    case 2:
