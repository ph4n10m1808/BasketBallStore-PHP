    ...
    <div class="d-flex">
        <div class="d-flex flex-column gap-2 me-3">
            <img class="rounded-3 shadow-sm" style="width: 80px; height: 80px; object-fit: cover; border: 2px solid transparent; cursor: pointer; transition: all 0.2s ease;"
                src="assets/<?= $productDetail['image1'] ?>" onclick="changeImage(this.getAttribute('src'))" alt="" onmouseover="this.style.borderColor='#4f46e5'" onmouseout="this.style.borderColor='transparent'">
            <img class="rounded-3 shadow-sm" style="width: 80px; height: 80px; object-fit: cover; border: 2px solid transparent; cursor: pointer; transition: all 0.2s ease;"
                src="assets/<?= $productDetail['image2'] ?>" onclick="changeImage(this.getAttribute('src'))" alt="" onmouseover="this.style.borderColor='#4f46e5'" onmouseout="this.style.borderColor='transparent'">
            <img class="rounded-3 shadow-sm" style="width: 80px; height: 80px; object-fit: cover; border: 2px solid transparent; cursor: pointer; transition: all 0.2s ease;"
                src="assets/<?= $productDetail['image3'] ?>" onclick="changeImage(this.getAttribute('src'))" alt="" onmouseover="this.style.borderColor='#4f46e5'" onmouseout="this.style.borderColor='transparent'">
            <img class="rounded-3 shadow-sm" style="width: 80px; height: 80px; object-fit: cover; border: 2px solid transparent; cursor: pointer; transition: all 0.2s ease;"
                src="assets/<?= $productDetail['image4'] ?>" onclick="changeImage(this.getAttribute('src'))" alt="" onmouseover="this.style.borderColor='#4f46e5'" onmouseout="this.style.borderColor='transparent'">
        </div>
        <div>
            <img id="image-detail" class="rounded-4 shadow-sm" style="width: 100%; max-width: 500px; aspect-ratio: 1/1; object-fit: cover;"
                src="assets/<?= $productDetail['image1'] ?>" alt="">
        </div>
    </div>
...
<div class="text-center">
    ...
    <ul style="list-style: none; display: flex; justify-content: center; flex-wrap: wrap; padding: 0">
        <li>
            <img class="mt-2 mb-2" style="width: 90%" src="assets/<?= $productDetail['image1'] ?>" alt="">
            <p class="text-center">Image 1</p>
        </li>
        <li>
            <img class="mt-2 mb-2" style="width: 90%" src="assets/<?= $productDetail['image2'] ?>" alt="">
            <p class="text-center">Image 2</p>
        </li>
        <li>
            <img class="mt-2 mb-2" style="width: 90%" src="assets/<?= $productDetail['image3'] ?>" alt="">
            <p class="text-center">Image 3</p>

        </li>
        <li>
            <img class="mt-2 mb-2" style="width: 90%" src="assets/<?= $productDetail['image4'] ?>" alt="">
            ...
            <ul class="gridpro d-flex flex-wrap">
                ...
                <li class="col-xs-6 col-sm-3 col-md-3 col-lg-3 col-gr grid li-normal">
                    <a class="product_img_link pro_img_home gray-darker nodeco " title="<?= $product['title_product'] ?>"
                        ...
                        <img src="assets/<?php echo $product['main_image'] ?>" alt="<?= $product['title_product'] ?>"
