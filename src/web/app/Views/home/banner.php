<div id="carouselExampleIndicators" class="carousel slide carousel-fade carousel-dark mb-5 position-relative"
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <a href="#"><img src="assets/<?= $data_banner[0]['url_banner'] ?>" class="d-block w-100" alt=""></a>
        </div>
        <?php
        for ($each = 1; $each < sizeof($data_banner); $each++) {
            ?>
            <div class="carousel-item">
                <a href="#"><img src="assets/<?php echo $data_banner[$each]['url_banner'] ?>" class="d-block w-100" alt=""></a>
            </div>
        <?php } ?>
    </div>
