<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    <form action="?mod=product&act=update&id=<?= $_GET['id'] ?>" method="POST" role="form" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <img style="max-width: 100px" src="assets/<?= $detailProduct['main_image'] ?>" alt="">
        ...
        <div class="form-group">
            ...
            <img style="max-width: 100px" src="assets/<?= $detailProduct['image1'] ?>" alt="">
        ...
        <div class="form-group">
            ...
            <img style="max-width: 100px" src="assets/<?= $detailProduct['image2'] ?>" alt="">
        ...
        <div class="form-group">
            ...
            <img style="max-width: 100px" src="assets/<?= $detailProduct['image3'] ?>" alt="">
        ...
        <div class="form-group">
            ...
            <img style="max-width: 100px" src="assets/<?= $detailProduct['image4'] ?>" alt="">
