<table class="table" id="dataTable" width="100%" cellspacing="0">
    ...
    <div class="form-group">
        <label for="">Image:
            <img style="max-width: 150px" src="assets/<?= $detailProduct['main_image'] ?>" alt="">
            <img style="max-width: 150px" src="assets/<?= $detailProduct['image1'] ?>" alt="">
            <img style="max-width: 150px" src="assets/<?= $detailProduct['image2'] ?>" alt="">
            <img style="max-width: 150px" src="assets/<?= $detailProduct['image3'] ?>" alt="">
            <img style="max-width: 150px" src="assets/<?= $detailProduct['image4'] ?>" alt="">
        </label>
    </div>
</table>