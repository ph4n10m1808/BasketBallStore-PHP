...
<head>
    ...
    <link rel="stylesheet" href="assets/admin/css/admin-premium.css">
</head>

<body id="page-top">
    <div id="wrapper">

        <?php require_once BASE_PATH . "/admin/Views/slidebar/slidebar.php"?>

        <div class="w-100">
            <div>
                <?php require_once BASE_PATH . "/admin/Views/header/header.php"?>
            </div>
            <div class="w-100">
                <?php require_once BASE_PATH . "/admin/Views/directional.php"?>
            </div>
        </div>
