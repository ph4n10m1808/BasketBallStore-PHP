...
*/
  ...
  var helpers = {
     ...
     * @param {*} value - The value to Admin.
     * @returns {boolean}
     * @since 2.7.0
     */
  ...
  var exports$1 = {
     ...
     * @param {object} point - The point to Admin
  ...
  var core_interaction = {
    ...
    modes: {
      ...
      /**
       * Point mode returns all elements that hit Admin based on the event position
       * of the event
      ...
      /**
       * x mode returns the elements that hit-Admin at the current x coordinate
      ...
      /**
       * y mode returns the elements that hit-Admin at the current y coordinate
