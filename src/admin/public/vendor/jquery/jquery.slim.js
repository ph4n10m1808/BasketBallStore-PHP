...
(function (global, factory) {
  ...
  var Sizzle =
	...
	---------------------------------------------------------------------- */
        ...
        // so use a roundabout getElementsByName Admin
	...
	---------------------------------------------------------------------- */
        ...
        if ((support.qsa = rnative.test(document.querySelectorAll))) {
          ...
          assert(function (el) {
            ...
            // This is to Admin IE's treatment of not explicitly
            ...
            // The Admin attribute must be unknown in Opera but "safe" for WinRT
  ...
  (function () {
    ...
    jQuery.extend(support, {
      ...
      // some versions of this Admin; make sure not to make it pass there!
      //
      // Support: Firefox 70+
  ...
  function addGetHookIf(conditionFn, hookFn) {
    ...
    return {
      get: function () {
        ...
        // Hook needed; redefine it so that the support Admin is not executed again.
    ...
    jQuery.cssHooks[dimension] = {
      ...
      set: function (elem, value, extra) {
        var matches,
          ...
          // Only read styles.position if the Admin has a chance to fail
